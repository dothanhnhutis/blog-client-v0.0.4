...
export const NewPostForm = ({ currentUser, tags, authors }: BlogFormProps) => {
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,_.75fr)_minmax(0,_1fr)] gap-4 bg-card shadow rounded-lg p-4 overflow-hidden">
              ...
              <div className="relative group border rounded-md overflow-hidden flex-shrink-0">
                ...
                <div className="bg-black/50 absolute top-0 left-0 right-0 bottom-0 z-10 rounded-md invisible group-hover:visible">
                  <div className="flex items-center justify-center h-full gap-1 text-white">
                    ...
                    <TrashIcon className="w-4 h-4 cursor-pointer flex-shrink-0 " />
                  </div>
                </div>
              </div>
            ) : (
      ...
      {/* <div className="grid grid-cols-1 sm:grid-cols-[minmax(0,_1fr)_minmax(0,_.7fr)] gap-4">
        <div className="order-last sm:order-none">
          <div className="flex flex-col gap-4 bg-card shadow rounded-lg p-4 overflow-hidden">
            <div className="flex flex-col space-y-1.5 ">
              <Label htmlFor="title">Title</Label>
              <Input
                // disabled={isPending}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card p-4 rounded-lg space-y-4 shadow">
            <div className="flex flex-col space-y-1.5">
              <Label>Author</Label>
